...
namespace Tank_Game
{
    public class Score
    {
        ...
        {
            spriteBatch.DrawString(spriteFont, "Player 1: " + score[0]+"               Player 2: "+score[1], Vector2.Zero, Color.Black);
            spriteBatch.DrawString(spriteFont, "Lives P1: " + game.tank1.lives + "               Lives P2: " + game.tank2.lives, new Vector2(0, 15), Color.Black);
        }
    }
}
