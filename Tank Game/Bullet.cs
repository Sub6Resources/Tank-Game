...
namespace Tank_Game
{
    ...
    public class Bullet
    {
        ...
        public virtual void CheckCollision()
        {
			...
			{
				if((Rectangle.Intersect(bulletRect, new Rectangle((int)et.location.X - (et.tankTexture.Width / 2), (int)et.location.Y - (et.tankTexture.Height / 2), et.tankTexture.Width, et.tankTexture.Height)).Width != 0) && et.alive && player != 10)
				{
					et.Hit();
			...
			if(player == 10 && (Rectangle.Intersect(bulletRect, new Rectangle((int)game.tank2.location.X - (game.tank2.tankTexture.Width / 2), (int)game.tank2.location.Y - (game.tank2.tankTexture.Height / 2), game.tank2.tankTexture.Width, game.tank2.tankTexture.Height)).Width != 0) && game.tank2.alive)
			{
				game.tank2.Hit();
				game.scoreManager.addScore(0, pointsOnHit);
				if (!game.tank2.alive)
			...
			if(player == 10 && (Rectangle.Intersect(bulletRect, new Rectangle((int)game.tank1.location.X - (game.tank1.tankTexture.Width / 2), (int)game.tank1.location.Y - (game.tank1.tankTexture.Height / 2), game.tank1.tankTexture.Width, game.tank1.tankTexture.Height)).Width != 0) && game.tank1.alive)
			{
				game.tank1.Hit();
				game.scoreManager.addScore(1, pointsOnHit);
				if (!game.tank1.alive)
