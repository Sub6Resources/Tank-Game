...
namespace Tank_Game
{
    class Tank
    {
        ...
        public Bullet Fire()
        {
            ...
            if(rotation == UP)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(0, -20), Color.White, player, UP, whiteRectangle);
            } else if(rotation== UP_RIGHT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(10, -10), Color.White, player, UP_RIGHT, whiteRectangle);
            } else if(rotation == RIGHT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(20, 0), Color.White, player, RIGHT, whiteRectangle);
            } else if(rotation ==DOWN_RIGHT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(10, 10), Color.White, player, DOWN_RIGHT, whiteRectangle);
            } else if(rotation == DOWN)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(0, 20), Color.White, player, DOWN, whiteRectangle);
            } else if(rotation == DOWN_LEFT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(-10, 10), Color.White, player, DOWN_LEFT, whiteRectangle);
            } else if(rotation == LEFT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(-20, 0), Color.White, player, LEFT, whiteRectangle);
            } else if(rotation == UP_LEFT)
            {
                return new Bullet(game, new Rectangle((int)location.X, (int)location.Y, 5, 20), new Vector2(-10, -10), Color.White, player, UP, whiteRectangle);//TODO
            } else
            {
                return null;
            }
